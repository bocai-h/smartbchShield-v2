      ...
      active: {
        ...
        target: {
          ...
          o: [
            ...
            {
              t:
                'f.您也可以选择“自己生成”注册私钥。请务必保证您的私钥足够随机，我们会要求您的私钥长度至少为16个字符,最长为64个字符，且至少包含一个小写字母和一个数字。从理论上讲，任何数字和字母字符串都可以用于生成您的Suter帐户，甚至可以使用非常简单的密码（例如“ 123456”）来生成您的Suter帐户，但这是绝对不安全，请不要这样做。 为了确保您的Suter账户的安全，请将您的私钥保存在安全的地方。',
            },
            {
              t:
